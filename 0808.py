...
def process(path, csv_writer):
    ...
    for file in li:
        ...
        cv2.imwrite("0808/lt/"+file,img_top_l)
        ...
        cv2.imwrite("0808/lb/"+file, img_bottom_l)
        ...
        cv2.imwrite("0808/rt/"+file, img_top_r)
        ...
        cv2.imwrite("0808/rb/"+file, img_bottom_r)
...
with open("result_0808.csv", 'w', newline='') as f:
